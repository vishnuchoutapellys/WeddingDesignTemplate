...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-[#3b020c] text-[#fdfaf3] pt-14 pb-16 md:pb-10 px-4 sm:px-6 text-center overflow-visible md:overflow-hidden border-t-4 border-[#d4af37]">
      {/* Decorative Golden Arch / Pattern at Top */}
      <div className="max-w-3xl w-full mx-auto relative z-10 flex flex-col items-center px-4">
        ...
        <h3 className="text-3xl sm:text-4xl font-script text-[#fef5b7] mt-1">
          {weddingConfig.groom.name}  <span className="text-[#d4af37] text-xl font-serif">&</span> {weddingConfig.bride.name}
        </h3>
